...
local ____modifier_item_arcane_blink_custom_731 = require("abilities.items.arcane_blink.731.modifier_item_arcane_blink_custom_731")
local modifier_item_arcane_blink_custom_731 = ____modifier_item_arcane_blink_custom_731.modifier_item_arcane_blink_custom_731
local ____modifier_item_arcane_blink_custom_731_buff = require("abilities.items.arcane_blink.731.modifier_item_arcane_blink_custom_731_buff")
local modifier_item_arcane_blink_custom_731_buff = ____modifier_item_arcane_blink_custom_731_buff.modifier_item_arcane_blink_custom_731_buff
____exports.item_arcane_blink_custom_731 = __TS__Class()
local item_arcane_blink_custom_731 = ____exports.item_arcane_blink_custom_731
item_arcane_blink_custom_731.name = "item_arcane_blink_custom_731"
__TS__ClassExtends(item_arcane_blink_custom_731, BlinkDaggerItem)
function item_arcane_blink_custom_731.prototype.GetIntrinsicModifierName(self)
    return modifier_item_arcane_blink_custom_731.name
end
function item_arcane_blink_custom_731.prototype.OnSpellStart(self)
    ...
    modifier_item_arcane_blink_custom_731_buff:apply(
        caster,
        caster,
        self,
...
function item_arcane_blink_custom_731.prototype.PlayEffects(self, origin)
    local caster = self:GetCaster()
...
item_arcane_blink_custom_731 = __TS__Decorate(
    item_arcane_blink_custom_731,
    item_arcane_blink_custom_731,
    {registerAbility(nil)},
    {kind = "class", name = "item_arcane_blink_custom_731"}
)
____exports.item_arcane_blink_custom_731 = item_arcane_blink_custom_731
return ____exports
